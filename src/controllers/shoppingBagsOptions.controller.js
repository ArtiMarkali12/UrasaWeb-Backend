...
export const getDropdownOptions = async (req, res) => {
  try {
    const options = await ShoppingBagsOption.getDropdownOptions();
    ...
    res.status(500).json({
      success: false,
      message: "Error fetching shopping bags dropdown options",
      error: error.message,
    });
  }
};
...
export const addCategory = async (req, res) => {
  try {
    ...
    const options = await ShoppingBagsOption.addCategory(
      categoryKey,
...
export const updateCategory = async (req, res) => {
  try {
    ...
    const options = await ShoppingBagsOption.updateCategory(categoryKey, {
      displayName,
      fieldType,
      placeholder,
      required,
...
export const updateSubcategoryField = async (req, res) => {
  try {
    ...
    const options = await ShoppingBagsOption.updateSubcategoryField(
      categoryKey,
      subcategoryKey,
