...
export const getAllOptions = async (req, res) => {
  try {
    ...
    res.status(500).json({
      success: false,
      message: "Error fetching notebook options",
      error: error.message,
    });
  }
};
...
export const getDropdownOptions = async (req, res) => {
  try {
    ...
    res.status(500).json({
      success: false,
      message: "Error fetching notebook dropdown options",
      error: error.message,
    });
  }
};
...
export const addCategory = async (req, res) => {
  try {
    ...
    const options = await NotebookOption.addCategory(
      categoryKey,
...
export const updateCategory = async (req, res) => {
  try {
    ...
    const options = await NotebookOption.updateCategory(categoryKey, {
      displayName,
      fieldType,
      placeholder,
      required,
...
export const updateSubcategoryField = async (req, res) => {
  try {
    ...
    const options = await NotebookOption.updateSubcategoryField(
      categoryKey,
      subcategoryKey,
