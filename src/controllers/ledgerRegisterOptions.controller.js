...
export const getDropdownOptions = async (req, res) => {
  try {
    const options = await LedgerRegisterOption.getDropdownOptions();
    ...
    res.status(500).json({
      success: false,
      message: "Error fetching ledger register dropdown options",
      error: error.message,
    });
  }
};
...
export const addCategory = async (req, res) => {
  try {
    ...
    const options = await LedgerRegisterOption.addCategory(
      categoryKey,
...
export const updateCategory = async (req, res) => {
  try {
    ...
    const options = await LedgerRegisterOption.updateCategory(categoryKey, {
      displayName,
      fieldType,
      placeholder,
      required,
...
export const updateSubcategoryField = async (req, res) => {
  try {
    ...
    const options = await LedgerRegisterOption.updateSubcategoryField(
      categoryKey,
      subcategoryKey,
