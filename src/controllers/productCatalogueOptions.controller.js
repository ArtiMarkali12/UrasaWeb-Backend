...
export const getDropdownOptions = async (req, res) => {
  try {
    const options = await ProductCatalogueOption.getDropdownOptions();
    ...
    res.status(500).json({
      success: false,
      message: "Error fetching product catalogue dropdown options",
      error: error.message,
    });
  }
};
...
export const addCategory = async (req, res) => {
  try {
    ...
    const options = await ProductCatalogueOption.addCategory(
      categoryKey,
...
export const updateCategory = async (req, res) => {
  try {
    ...
    const options = await ProductCatalogueOption.updateCategory(categoryKey, {
      displayName,
      fieldType,
      placeholder,
      required,
...
export const updateSubcategoryField = async (req, res) => {
  try {
    ...
    const options = await ProductCatalogueOption.updateSubcategoryField(
      categoryKey,
      subcategoryKey,
