...
export const getDropdownOptions = async (req, res) => {
  try {
    const options = await PamphletOption.getDropdownOptions();
    ...
    res.status(500).json({
      success: false,
      message: "Error fetching pamphlet dropdown options",
      error: error.message,
    });
  }
};
...
export const addCategory = async (req, res) => {
  try {
    ...
    const options = await PamphletOption.addCategory(
      categoryKey,
...
export const updateCategory = async (req, res) => {
  try {
    ...
    const options = await PamphletOption.updateCategory(categoryKey, {
      displayName,
      fieldType,
      placeholder,
      required,
...
export const updateSubcategoryField = async (req, res) => {
  try {
    ...
    const options = await PamphletOption.updateSubcategoryField(
      categoryKey,
      subcategoryKey,
