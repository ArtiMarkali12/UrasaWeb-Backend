...
export const createShoppingBagQuote = async (data) => {
  const shoppingBag = new ShoppingBags(data);
  return await shoppingBag.save();
};
...
export const updateShoppingBag = async (id, data) => {
  return await ShoppingBags.findByIdAndUpdate(id, data, { new: true });
};
