...
router.post("/book-sizes", (req, res) =>
  optionsController.addOptionValue(req, res, "bookSizes"),
);
router.post("/binding-types", (req, res) =>
  optionsController.addOptionValue(req, res, "bindingTypes"),
);
router.post("/cover-styles", (req, res) =>
  optionsController.addOptionValue(req, res, "coverStyles"),
);
...
router.post("/page-edges", (req, res) =>
  optionsController.addOptionValue(req, res, "pageEdges"),
);
router.post("/packaging", (req, res) =>
  optionsController.addOptionValue(req, res, "packaging"),
);
router.post("/special-finishing", (req, res) =>
  optionsController.addOptionValue(req, res, "specialFinishing"),
);

/* Generic API for dynamic categories */
router.post("/options/:category", (req, res) => {
  const { category } = req.params;
  optionsController.addOptionValue(req, res, category);
});
router.put("/options/:category/:index", (req, res) => {
  const { category, index } = req.params;
  optionsController.updateOptionValue(req, res, category, index);
});
router.delete("/options/:category/:index", (req, res) => {
  const { category, index } = req.params;
  optionsController.deleteOptionValue(req, res, category, index);
});

/* PUT APIs - Update Option Values */
router.put("/book-sizes/:index", (req, res) =>
  optionsController.updateOptionValue(req, res, "bookSizes"),
);
...
router.put("/page-edges/:index", (req, res) =>
  optionsController.updateOptionValue(req, res, "pageEdges"),
);

/* DELETE APIs - Delete Option Values */
router.delete("/book-sizes/:index", (req, res) =>
  optionsController.deleteOptionValue(req, res, "bookSizes"),
);
...
router.delete("/page-edges/:index", (req, res) =>
  optionsController.deleteOptionValue(req, res, "pageEdges"),
);
