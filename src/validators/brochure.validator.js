const validateBrochureQuote = (req, res, next) => {
  const { foldStyle, size, paperStock, quantity, customerDetails } = req.body;

  // Validate required fields
  if (!foldStyle) {
    return res.status(400).json({
      success: false,
      message: "Fold style is required",
    });
  }
...
export default validateBrochureQuote;
