...
CustomCardOptionSchema.statics.getAllOptions = async function () {
...
CustomCardOptionSchema.statics.deleteCategory = async function (categoryKey) {
  let options = await this.findOne();
...
CustomCardOptionSchema.statics.deleteSubcategory = async function (
  categoryKey,
  subcategoryKey,
) {
  let options = await this.findOne();
...
CustomCardOptionSchema.statics.addAttribute = async function (
  categoryKey,
  subcategoryKey,
  value,
) {
...
CustomCardOptionSchema.statics.updateAttribute = async function (
  categoryKey,
  subcategoryKey,
  index,
  newValue,
...
CustomCardOptionSchema.statics.deleteAttribute = async function (
  categoryKey,
  subcategoryKey,
  index,
) {
...
CustomCardOptionSchema.statics.addCategoryAttribute = async function (
  categoryKey,
  value,
) {
  let options = await this.findOne();
...
CustomCardOptionSchema.statics.updateCategoryAttribute = async function (
  categoryKey,
  index,
  newValue,
) {
...
CustomCardOptionSchema.statics.deleteCategoryAttribute = async function (
  categoryKey,
  index,
) {
  let options = await this.findOne();
...
export default mongoose.model("CustomCardOption", CustomCardOptionSchema);
