...
const ShoppingBagsOptionSchema = new mongoose.Schema(
  {
...
ShoppingBagsOptionSchema.statics.getAllOptions = async function () {
...
ShoppingBagsOptionSchema.statics.addCategory = async function (
  categoryKey,
  displayName,
  fieldType = "select",
  placeholder = "",
...
ShoppingBagsOptionSchema.statics.updateCategory = async function (
  categoryKey,
  updates,
) {
  let options = await this.findOne();
...
ShoppingBagsOptionSchema.statics.addSubcategory = async function (
  categoryKey,
  subcategoryKey,
  displayName,
  fieldType = "select",
...
ShoppingBagsOptionSchema.statics.updateSubcategoryField = async function (
  categoryKey,
  subcategoryKey,
  fieldConfig,
) {
...
ShoppingBagsOptionSchema.statics.deleteCategory = async function (categoryKey) {
  let options = await this.findOne();
...
ShoppingBagsOptionSchema.statics.deleteSubcategory = async function (
  categoryKey,
  subcategoryKey,
) {
  let options = await this.findOne();
...
ShoppingBagsOptionSchema.statics.addAttribute = async function (
  categoryKey,
  subcategoryKey,
  value,
) {
...
ShoppingBagsOptionSchema.statics.updateAttribute = async function (
  categoryKey,
  subcategoryKey,
  index,
  newValue,
...
ShoppingBagsOptionSchema.statics.deleteAttribute = async function (
  categoryKey,
  subcategoryKey,
  index,
) {
...
ShoppingBagsOptionSchema.statics.addCategoryAttribute = async function (
  categoryKey,
  value,
) {
  let options = await this.findOne();
...
ShoppingBagsOptionSchema.statics.updateCategoryAttribute = async function (
  categoryKey,
  index,
  newValue,
) {
...
ShoppingBagsOptionSchema.statics.deleteCategoryAttribute = async function (
  categoryKey,
  index,
) {
  let options = await this.findOne();
...
ShoppingBagsOptionSchema.statics.getDropdownOptions = async function () {
...
export default mongoose.model("ShoppingBagsOption", ShoppingBagsOptionSchema);
