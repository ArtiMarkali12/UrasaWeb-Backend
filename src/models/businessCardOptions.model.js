...
const BusinessCardOptionSchema = new mongoose.Schema(
  {
...
BusinessCardOptionSchema.statics.getAllOptions = async function () {
...
BusinessCardOptionSchema.statics.addCategory = async function (
  categoryKey,
  displayName,
  fieldType = "select",
  placeholder = "",
...
BusinessCardOptionSchema.statics.addSubcategory = async function (
  categoryKey,
  subcategoryKey,
  displayName,
  fieldType = "select",
...
BusinessCardOptionSchema.statics.updateCategory = async function (
  categoryKey,
  updates,
) {
  let options = await this.findOne();
...
BusinessCardOptionSchema.statics.updateSubcategoryField = async function (
  categoryKey,
  subcategoryKey,
  fieldConfig,
) {
...
BusinessCardOptionSchema.statics.deleteCategory = async function (categoryKey) {
  let options = await this.findOne();
...
BusinessCardOptionSchema.statics.deleteSubcategory = async function (
  categoryKey,
  subcategoryKey,
) {
  let options = await this.findOne();
...
BusinessCardOptionSchema.statics.addAttribute = async function (
  categoryKey,
  subcategoryKey,
  value,
) {
...
BusinessCardOptionSchema.statics.updateAttribute = async function (
  categoryKey,
  subcategoryKey,
  index,
  newValue,
...
BusinessCardOptionSchema.statics.deleteAttribute = async function (
  categoryKey,
  subcategoryKey,
  index,
) {
...
BusinessCardOptionSchema.statics.addCategoryAttribute = async function (
  categoryKey,
  value,
) {
  let options = await this.findOne();
...
BusinessCardOptionSchema.statics.updateCategoryAttribute = async function (
  categoryKey,
  index,
  newValue,
) {
...
BusinessCardOptionSchema.statics.deleteCategoryAttribute = async function (
  categoryKey,
  index,
) {
  let options = await this.findOne();
...
BusinessCardOptionSchema.statics.getDropdownOptions = async function () {
...
export default mongoose.model("BusinessCardOption", BusinessCardOptionSchema);
