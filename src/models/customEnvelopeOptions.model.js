...
CustomEnvelopeOptionSchema.statics.addCategory = async function (
  categoryKey,
  displayName,
  fieldType = "select",
  placeholder = "",
...
CustomEnvelopeOptionSchema.statics.updateCategory = async function (
  categoryKey,
  updates,
) {
  let options = await this.findOne();
...
CustomEnvelopeOptionSchema.statics.updateSubcategoryField = async function (
  categoryKey,
  subcategoryKey,
  fieldConfig,
) {
...
CustomEnvelopeOptionSchema.statics.getDropdownOptions = async function () {
