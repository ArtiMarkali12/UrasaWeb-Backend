...
const LedgerRegisterOptionSchema = new mongoose.Schema(
  {
...
LedgerRegisterOptionSchema.statics.getAllOptions = async function () {
...
LedgerRegisterOptionSchema.statics.addCategory = async function (
  categoryKey,
  displayName,
  fieldType = "select",
  placeholder = "",
...
LedgerRegisterOptionSchema.statics.updateCategory = async function (
  categoryKey,
  updates,
) {
  let options = await this.findOne();
...
LedgerRegisterOptionSchema.statics.addSubcategory = async function (
  categoryKey,
  subcategoryKey,
  displayName,
  fieldType = "select",
...
LedgerRegisterOptionSchema.statics.updateSubcategoryField = async function (
  categoryKey,
  subcategoryKey,
  fieldConfig,
) {
...
LedgerRegisterOptionSchema.statics.deleteCategory = async function (
  categoryKey,
) {
  let options = await this.findOne();
...
LedgerRegisterOptionSchema.statics.deleteSubcategory = async function (
  categoryKey,
  subcategoryKey,
) {
  let options = await this.findOne();
...
LedgerRegisterOptionSchema.statics.addAttribute = async function (
  categoryKey,
  subcategoryKey,
  value,
) {
...
LedgerRegisterOptionSchema.statics.updateAttribute = async function (
  categoryKey,
  subcategoryKey,
  index,
  newValue,
...
LedgerRegisterOptionSchema.statics.deleteAttribute = async function (
  categoryKey,
  subcategoryKey,
  index,
) {
...
LedgerRegisterOptionSchema.statics.addCategoryAttribute = async function (
  categoryKey,
  value,
) {
  let options = await this.findOne();
...
LedgerRegisterOptionSchema.statics.updateCategoryAttribute = async function (
  categoryKey,
  index,
  newValue,
) {
...
LedgerRegisterOptionSchema.statics.deleteCategoryAttribute = async function (
  categoryKey,
  index,
) {
  let options = await this.findOne();
...
LedgerRegisterOptionSchema.statics.getDropdownOptions = async function () {
...
export default mongoose.model(
  "LedgerRegisterOption",
  LedgerRegisterOptionSchema,
);
