...
const BrochureOptionSchema = new mongoose.Schema(
  {
...
BrochureOptionSchema.statics.getAllOptions = async function () {
...
BrochureOptionSchema.statics.addCategory = async function (
  categoryKey,
  displayName,
  fieldType = "select",
  placeholder = "",
...
BrochureOptionSchema.statics.updateCategory = async function (
  categoryKey,
  updates,
) {
  let options = await this.findOne();
...
BrochureOptionSchema.statics.addSubcategory = async function (
  categoryKey,
  subcategoryKey,
  displayName,
  fieldType = "select",
...
BrochureOptionSchema.statics.updateSubcategoryField = async function (
  categoryKey,
  subcategoryKey,
  updates,
) {
...
BrochureOptionSchema.statics.deleteCategory = async function (categoryKey) {
  let options = await this.findOne();
...
BrochureOptionSchema.statics.deleteSubcategory = async function (
  categoryKey,
  subcategoryKey,
) {
  let options = await this.findOne();
...
BrochureOptionSchema.statics.addAttribute = async function (
  categoryKey,
  subcategoryKey,
  value,
) {
...
BrochureOptionSchema.statics.updateAttribute = async function (
  categoryKey,
  subcategoryKey,
  index,
  newValue,
...
BrochureOptionSchema.statics.deleteAttribute = async function (
  categoryKey,
  subcategoryKey,
  index,
) {
...
BrochureOptionSchema.statics.addCategoryAttribute = async function (
  categoryKey,
  value,
) {
  let options = await this.findOne();
...
BrochureOptionSchema.statics.updateCategoryAttribute = async function (
  categoryKey,
  index,
  newValue,
) {
...
BrochureOptionSchema.statics.deleteCategoryAttribute = async function (
  categoryKey,
  index,
) {
  let options = await this.findOne();
...
export default mongoose.model("BrochureOption", BrochureOptionSchema);
